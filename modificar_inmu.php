<?php
	...
	$sql = "SELECT * FROM inmueble WHERE id_inmu ='$idCliente'";
	...
	<body>
		<div class="container">
			...
			<div class="form-group">
					...
					<div class="col-sm-10">
                        <input type="text" class="form-control" id="id_inmu" name="id_inmu" placeholder="Ingrese su Nombre" value="<?php echo $row['id_inmu']; ?>"  required>
					</div>
				</div>
