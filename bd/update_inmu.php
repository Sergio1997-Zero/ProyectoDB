<?php
	...
	$sql = "UPDATE inmueble SET id_inmu='$id_inmu', direc_inmu='$direc_inmu', tip_inmu='$tip_inmu', arri_inmu='$arri_inmu', cant_habi='$cant_habi' cant_bano='$cant_bano', parq_inmu'$parq_inmu', cont_cocina=$cont_cocina, id_arren'$id_arren'   WHERE id_inmu='$id_inmu'";
